      ...
      <div className="mx-auto w-[min(1180px,calc(100%-40px))]">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <article className={card}>
            ...
            <span className="mt-5 inline-flex rounded-full bg-amber-100 px-3 py-1 text-sm font-black text-amber-700">Domain Support</span>
            <h3 className="mt-3 text-3xl font-black text-slate-950">Domain Purchase Support</h3>
            <strong className="mt-2 block text-2xl font-black text-blue-700">৳1,500+</strong>
            <p className="mt-3 leading-7 text-slate-600">International provider থেকে domain কেনার জন্য সহজ ও পরিষ্কার support.</p>
        ...
        <div className="mt-8 flex justify-center gap-3"><Button href={brand.whatsapp}>Order Support</Button><Button href="#contact" variant="ghost-dark">Contact Us</Button></div>
      </div>
    </section>
  )
}
