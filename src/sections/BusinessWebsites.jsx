...
export default function BusinessWebsites() {
  return (
    <section className="bg-gradient-to-br from-[#eef6ff] via-[#f8fbff] to-[#e9f1ff] py-20 lg:py-24" id="business-websites">
      <div className="mx-auto grid w-[min(1180px,calc(100%-40px))] items-center gap-10 lg:grid-cols-2">
        ...
        <div className="rounded-[2rem] border border-blue-100 bg-gradient-to-br from-white to-blue-50 p-6 text-slate-950 shadow-2xl shadow-blue-950/10">
          ...
          <div className="rounded-3xl border border-blue-100 bg-white p-7"><small className="font-extrabold text-blue-700">Professional Website</small><h3 className="mt-3 text-3xl font-black leading-tight tracking-[-0.04em]">Build trust, showcase your work and collect leads</h3><p className="mt-4 leading-7 text-slate-600">Modern layout, service highlights, portfolio area, testimonials and WhatsApp/Facebook contact flow.</p></div>
          <div className="mt-4 grid grid-cols-2 gap-4"><div className="rounded-3xl bg-blue-100 p-5"><strong>Portfolio</strong><span className="block text-sm text-slate-600">Work showcase</span></div><div className="rounded-3xl bg-amber-100 p-5"><strong>Landing</strong><span className="block text-sm text-slate-600">Campaign focused</span></div></div>
        </div>
      </div>
    </section>
  )
